...
dirSwitch?.addEventListener("change", (e) => {
  ...
  if (checkbox.checked) {
    ...
    rtlLink.href = "/pos_home_delivery/static/assets/css/vendors/bootstrap.rtl.min.css";
    localStorage.setItem("rtlcss", "/pos_home_delivery/static/assets/css/vendors/bootstrap.rtl.min.css");
    localStorage.setItem("dir", "rtl");
  }

  if (!checkbox.checked) {
    htmlDom.setAttribute("dir", "ltr");
    rtlLink.href = "/pos_home_delivery/static/assets/css/vendors/bootstrap.min.css";
    localStorage.setItem("rtlcss", "/pos_home_delivery/static/assets/css/vendors/bootstrap.min.css");
    localStorage.setItem("dir", "ltr");
  }
});
// Rtl
htmlDom.setAttribute("dir", localStorage.getItem("dir") ? localStorage.getItem("dir") : "ltr");
rtlLink.href = localStorage.getItem("rtlcss") ? localStorage.getItem("rtlcss") : "/pos_home_delivery/static/assets/css/vendors/bootstrap.min.css";
